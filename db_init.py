...
def init_db():
    ...
    real_users = [
        ...
        (2, 'vveeqqpprr', 'Элина', '', False),
        (3, 'LAGMAAAAN', 'Saida', '', False),
        (4, 'jarixxaa', 'Adjara', '', False),
        (5, 'wualov', 'Жолдаскан Фируза', '', False),
        (6, 'Tengri_cat', 'Нитар', '', False),
        (7, 'Konstanteeeen', 'Константин', '', False),
        (8, 'AIKQYWX', 'Saleh Aikyz', '', False),
        (9, 'khandrok', 'Алихан Калыбеков', '', False),
        (10, 'None', 'Ермурат Турлибеков', '', False),
        (11, 'aamiovee', 'Элин', '', False),
        (12, 'killstationexxidae', 'Наги', '', False),
        (13, 'd2sease', 'Алина', '', False),
        (14, 'nariwaaa', 'Ками', '', False),
        (15, 'alisherthegreat', 'Абас Алишер', '', False),
        (16, 'pow3lnah', 'Users', '', False),
        (17, 'ClayzDart', 'Диас', '', False),
        (18, 'asikoakhmetova', 'Ахметова Асылым', '', False),
        (19, 'None', 'Заида', '', False),
        (20, 'None', 'Аслан Мирабдулла', '', False),
        (21, 'amillienn', 'амина', '', False),
        (22, 'bekam1na', 'Амина', '', False),
        (23, 'dulbl4', 'Дулат', '', False),
        (24, 'Kadihdj', 'Төлегенқызы Қадиша', '', False),
        (25, 'thch0l', 'Tsoi', '', False),
        (26, 'AyankaD', 'Аяна', '', False),
        (27, 'ewelyl', 'Шатырбеков Даурен', '', False),
        (28, 'lankikinn', 'Нұрмахан Нұрила', '', False),
        (29, 'qwiiskz', 'Хе Диана', '', False),
        (30, 'glebdmitriyev', 'Дмитриев Глеб', '', False),
        (31, 'akkayasha', 'мухтарқызы амина', '', False),
        (32, 'diana_rollan', 'Аяна Адам', '', False),
        (33, 'werexx', 'Артемий', '', False),
        (34, 'extrareader', 'Нурай Еркинбек', '', False),
        (35, 'tiamolr', 'Акмаржан Амирханова', '', False),
        (36, 'ayashhk', 'Аяжан', '', False),
        (37, 'azrrrra', 'Айзере', '', False),
        (38, 'lanenotpunk', 'Романас', '', False),
        (39, 'OlzhasJKY', 'Ибрагим Олжас Дидарұлы', '', False),
        (40, 'Y_u_zuha', 'Иманберді Көркем', '', False),
